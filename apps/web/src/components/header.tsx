...
import { PerfilFormModal } from '@/pages/Settings/components/PerfilFormModal'
...
export function Header({ onToggleDesktopSidebar }: HeaderProps) {
  ...
  const [isPerfilFormModalOpened, setIsPerfilFormModalOpened] = useState(false)
  ...
  return (
    <>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem
                    ...
                    onClick={() => setIsPerfilFormModalOpened(true)}
                  >
                    Perfil
                  </DropdownMenuItem>
                  <DropdownMenuItem
      ...
      <PerfilFormModal
        isOpened={isPerfilFormModalOpened}
        onClose={() => setIsPerfilFormModalOpened(false)}
      />
    </>
  )
}
